...
**I've included my resume, the plane project, and some miscellaneous projects in this ([rcaerbannog](https://github.com/rcaerbannog/rcaerbannog)) repository that were either from programming/project books or small experiments that I don't think merit a full repository. My IR car and quadruped projects are available in their own repositories, as are other programming projects from high school.** 
